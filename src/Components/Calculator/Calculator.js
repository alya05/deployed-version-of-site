              ...
              <div className="calculator__parameter-container">
                ...
                <div className="calculator__parameters-line">
                  <div className="calculator__parameter">
                    <div onClick={this.removeRoom} className="calculator__parameter-text">
                      <span>-</span>
                    </div>
                    <div className="calculator__parameter-text--center">{this.renderRoomCount()}</div>
                    <div onClick={this.addRoom} className="calculator__parameter-text">
                      <span>+</span>
                    </div>
                  </div>
                  <div className="calculator__parameter">
                    <div onClick={this.removeBathRoom} className="calculator__parameter-text">
                      <span>-</span>
                    </div>
                    <div className="calculator__parameter-text--center">{this.renderBathroomCount()}</div>
                    <div onClick={this.addBathRoom} className="calculator__parameter-text">
                      <span>+</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="calculator__parameter-container">
                ...
                <div className="calculator__address">
                  <div className="calculator__address-container">
                    <input type="text" disabled={true} maxLength="15" value={'Солигорск'} ref="city" className="calculator__input--long"/>
